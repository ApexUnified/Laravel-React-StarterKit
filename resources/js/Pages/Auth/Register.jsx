                            ...
                            <form onSubmit={submit}>
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        >
                                            Name<span className="text-red-500 dark:text-white"> *</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="name"
                                        ...
                                        {errors.name && <span className="text-red-500 dark:text-white">{errors.name}</span>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {errors.password && <span className="text-red-500 dark:text-white">{errors.password}</span>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            >
                                                <svg
                                                    ...
                                                    className={showPasswordConfirmation ? "fill-current " : "hidden"}
                                                    width="20"
                                                    height="20"
                                                    viewBox="0 0 20 20"
                                                    fill="none"
                                        ...
                                        {errors.password_confirmation && <span className="text-red-500 dark:text-white">{errors.password_confirmation}</span>}
                                    </div>
