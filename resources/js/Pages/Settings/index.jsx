                    ...
                    <>
                        <div className="flex justify-around gap-5 flex-wrap items-center">
                            <Card
                                ...
                                Content={
                                    <>
                                        <div className='w-20 h-20 rounded-full flex justify-center items-center bg-gray-100 dark:bg-gray-800 mb-3'>
                                        ...
                                        <p className="text-gray-600 dark:text-white text-center mb-6 leading-relaxed">
